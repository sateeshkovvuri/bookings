...
wss.on('connection', (ws) => {
    ...
    (async () => {
        ...
        let bookingDetails = require("./bookingDetails.json")
        ...
        clientInputEvent.once("solved-login-captcha",async(captcha)=>{
            ...
            if(train == null){
                ...
                const coachSelectionStatus = await coachSelectionHandler(page,train,bookingDetails).catch(err=>{
                    console.log(err)
                });
                ...
                if(availability.indexOf("AVAILABLE")!=-1){
                    ...
                    //create slots to fill passenger details,already one slot will be available.
                    if(totalPassengers>1){
                        ...
                        console.log("Only 1 passenger,extra slots not required")
                    }
                    ...
                    //selecting upi payment method, payments through cards are getting blocked!
